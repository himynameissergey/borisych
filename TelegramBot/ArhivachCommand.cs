...
{
    class ArhivachCommand : ICommand
    {
        /// <summary>
        /// Имя команды
        /// </summary>
        public string Name { get; set; } = "/arhivach";
        ...
        {
            await client.SendTextMessageAsync(message.Chat.Id, @"Введите ""/arhivach"" ");
            Bot.ConsoleWriteLog(message);
        }
        public static void Parser_OnCompleted(object obj)
        {
            Console.WriteLine("\nПарсер arhivach.org отработал!\n");
        }
