...
{
    class KMPSettings : IParserSettings
    {
        public KMPSettings(int start, int end)
        {
            StartPoint = start;
            EndPoint = end;
        }
        ...
        //public string BaseUrl { get; set; } = "https://www.reddit.com/r/PornStarHQ/";
        public string BaseUrl { get; set; } = "https://killpls.me";
