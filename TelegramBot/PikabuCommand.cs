...
{
    class PikabuCommand : ICommand
    {
        /// <summary>
        /// Имя команды
        /// </summary>
        public string Name { get; set; } = "/pikabu";
        ...
        {
            await client.SendTextMessageAsync(message.Chat.Id, @"Введите ""/pikabu"" ");
            Bot.ConsoleWriteLog(message);
        }
        public static void Parser_OnCompleted(object obj)
        {
            Console.WriteLine("\nПарсер pikabu.ru отработал!\n");
        }
